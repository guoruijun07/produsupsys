...
public class OnlineWebSessionManager extends DefaultWebSessionManager
{
    ...
    public void setAttribute(SessionKey sessionKey, Object attributeKey, Object value) throws InvalidSessionException
    {
        ...
        {
            com.ruoyi.framework.shiro.session.OnlineSession session = getOnlineSession(sessionKey);
    ...
    public Object removeAttribute(SessionKey sessionKey, Object attributeKey) throws InvalidSessionException
    {
        ...
        if (removed != null)
        {
            com.ruoyi.framework.shiro.session.OnlineSession s = getOnlineSession(sessionKey);
    ...
    public com.ruoyi.framework.shiro.session.OnlineSession getOnlineSession(SessionKey sessionKey)
    {
        com.ruoyi.framework.shiro.session.OnlineSession session = null;
        Object obj = doGetSession(sessionKey);
        if (StringUtils.isNotNull(obj))
        {
            session = new com.ruoyi.framework.shiro.session.OnlineSession();
