...
public class SysRegisterService
{
    ...
    public String register(SysUser user)
    {
        ...
        {
            user.setSalt(com.bjyx.framework.util.ShiroUtils.randomSalt());
            ...
            {
                com.bjyx.framework.manager.AsyncManager.me().execute(com.bjyx.framework.manager.factory.AsyncFactory.recordLogininfor(username, Constants.REGISTER, MessageUtils.message("user.register.success")));
            }
        }
        return msg;
    }
