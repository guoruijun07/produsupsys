package com.bjyx.framework.shiro.web.session;
...
import com.bjyx.common.utils.bean.BeanUtils;
...
public class OnlineWebSessionManager extends DefaultWebSessionManager
{
    ...
    public void setAttribute(SessionKey sessionKey, Object attributeKey, Object value) throws InvalidSessionException
    {
        ...
        {
            com.bjyx.framework.shiro.session.OnlineSession session = getOnlineSession(sessionKey);
    ...
    public Object removeAttribute(SessionKey sessionKey, Object attributeKey) throws InvalidSessionException
    {
        ...
        if (removed != null)
        {
            com.bjyx.framework.shiro.session.OnlineSession s = getOnlineSession(sessionKey);
    ...
    public com.bjyx.framework.shiro.session.OnlineSession getOnlineSession(SessionKey sessionKey)
    {
        com.bjyx.framework.shiro.session.OnlineSession session = null;
        Object obj = doGetSession(sessionKey);
        if (StringUtils.isNotNull(obj))
        {
            session = new com.bjyx.framework.shiro.session.OnlineSession();
