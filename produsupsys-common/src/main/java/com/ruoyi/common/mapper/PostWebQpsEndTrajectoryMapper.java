...
public interface PostWebQpsEndTrajectoryMapper {
     ...
     */
    @Delete({
        "delete from post_web_qps_end_trajectory",
     ...
     */
    @Insert({
        "insert into post_web_qps_end_trajectory (id, traceNo, ",
        "opTime, opName, ",
    ...
    int insert(com.ruoyi.common.bean.po.PostWebQpsEndTrajectory record);
    ...
    @Select({
        ...
        "from post_web_qps_end_trajectory",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @ConstructorArgs({
    ...
    com.ruoyi.common.bean.po.PostWebQpsEndTrajectory selectByPrimaryKey(Integer id);
     ...
     */
    @Update({
        "update post_web_qps_end_trajectory",
    ...
    int updateByPrimaryKey(com.ruoyi.common.bean.po.PostWebQpsEndTrajectory record);
}