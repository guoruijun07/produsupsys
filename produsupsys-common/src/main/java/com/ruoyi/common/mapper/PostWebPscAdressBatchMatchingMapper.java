...
import com.ruoyi.common.bean.po.PostWebPscAdressBatchMatching;

public interface PostWebPscAdressBatchMatchingMapper {
     ...
     */
    @Delete({
        "delete from post_web_psc_adress_batch_matching",
     ...
     */
    @Insert({
        "insert into post_web_psc_adress_batch_matching (id, batch_no, ",
        "file_name, total_num, ",
        "success_num, money, ",
        "status, user_id, ",
    ...
    int insert(PostWebPscAdressBatchMatching record);
    ...
    @Select({
        ...
        "create_time",
        "from post_web_psc_adress_batch_matching",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @ConstructorArgs({
   ...
   PostWebPscAdressBatchMatching selectByPrimaryKey(Integer id);
     ...
     */
    @Update({
        "update post_web_psc_adress_batch_matching",
    ...
    int updateByPrimaryKey(PostWebPscAdressBatchMatching record);
}