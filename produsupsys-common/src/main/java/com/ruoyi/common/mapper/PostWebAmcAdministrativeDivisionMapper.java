...
import com.ruoyi.common.bean.po.PostWebAmcAdministrativeDivision;
...
public interface PostWebAmcAdministrativeDivisionMapper {
    ...
    int insert(PostWebAmcAdministrativeDivision record);
    ...
    PostWebAmcAdministrativeDivision selectByPrimaryKey(Integer id);
    ...
    int updateByPrimaryKey(PostWebAmcAdministrativeDivision record);
}