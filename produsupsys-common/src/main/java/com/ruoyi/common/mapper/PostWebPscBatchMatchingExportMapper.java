...
import com.ruoyi.common.bean.po.PostWebPscBatchMatchingExport;

public interface PostWebPscBatchMatchingExportMapper {
     ...
     */
    @Delete({
        "delete from post_web_psc_batch_matching_export",
     ...
     */
    @Insert({
        "insert into post_web_psc_batch_matching_export (id, user_id, ",
        "file_name, total_num, ",
        "sucess_num, money, ",
        "create_time, remark)",
    ...
    int insert(PostWebPscBatchMatchingExport record);
    ...
    @Select({
        ...
        "from post_web_psc_batch_matching_export",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @ConstructorArgs({
   ...
   PostWebPscBatchMatchingExport selectByPrimaryKey(Integer id);
     ...
     */
    @Update({
        "update post_web_psc_batch_matching_export",
    ...
    int updateByPrimaryKey(PostWebPscBatchMatchingExport record);
}