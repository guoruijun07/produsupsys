...
public interface PostWebQpsDetailTrajectoryOutsideMapper {
     ...
     */
    @Delete({
        "delete from post_web_qps_detail_trajectory_outside",
     ...
     */
    @Insert({
        "insert into post_web_qps_detail_trajectory_outside (id, traceNo, ",
        "opTime, opCode, ",
        "opName, opDesc, ",
    ...
    int insert(com.ruoyi.common.bean.po.PostWebQpsDetailTrajectoryOutside record);
    ...
    @Select({
        ...
        "from post_web_qps_detail_trajectory_outside",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @ConstructorArgs({
    ...
    com.ruoyi.common.bean.po.PostWebQpsDetailTrajectoryOutside selectByPrimaryKey(Integer id);
     ...
     */
    @Update({
        "update post_web_qps_detail_trajectory_outside",
    ...
    int updateByPrimaryKey(com.ruoyi.common.bean.po.PostWebQpsDetailTrajectoryOutside record);
}