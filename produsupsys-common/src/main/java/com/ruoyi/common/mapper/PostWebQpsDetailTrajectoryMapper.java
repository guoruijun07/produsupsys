...
public interface PostWebQpsDetailTrajectoryMapper {
     ...
     */
    @Delete({
        "delete from post_web_qps_detail_trajectory",
     ...
     */
    @Insert({
        "insert into post_web_qps_detail_trajectory (id, traceNo, ",
    ...
    int insert(com.ruoyi.common.bean.po.PostWebQpsDetailTrajectory record);
    ...
    @Select({
        ...
        "source, remark",
        "from post_web_qps_detail_trajectory",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @ConstructorArgs({
    ...
    com.ruoyi.common.bean.po.PostWebQpsDetailTrajectory selectByPrimaryKey(Integer id);
     ...
     */
    @Update({
        "update post_web_qps_detail_trajectory",
    ...
    int updateByPrimaryKey(com.ruoyi.common.bean.po.PostWebQpsDetailTrajectory record);
}