...
public interface PostPkpClientOrderMapper {
     ...
     */
    @Delete({
        "delete from post_pkp_client_order",
        "where id = #{id,jdbcType=BIGINT}",
          "and is_fee = #{isFee,jdbcType=CHAR}"
    })
    int deleteByPrimaryKey(PostPkpClientOrder key);
     ...
     */
    @Insert({
        "insert into post_pkp_client_order (id, is_fee, order_date, ",
        "send_date, company, ",
    ...
    int updateByPrimaryKey(PostPkpClientOrder record);
}