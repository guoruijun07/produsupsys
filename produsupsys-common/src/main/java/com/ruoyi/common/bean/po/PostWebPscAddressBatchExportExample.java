...
public class PostWebPscAddressBatchExportExample {
    /**
     * post_web_psc_address_batch_export
     */
     ...
     * post_web_psc_address_batch_export
     */
    protected java.util.List<com.ruoyi.common.bean.po.PostWebPscAddressBatchExportExample.Criteria> oredCriteria;

    /**
     *
     * @mbggenerated
     */
    public PostWebPscAddressBatchExportExample() {
        oredCriteria = new java.util.ArrayList<com.ruoyi.common.bean.po.PostWebPscAddressBatchExportExample.Criteria>();
    }
     ...
     * @mbggenerated
     */
    public java.util.List<com.ruoyi.common.bean.po.PostWebPscAddressBatchExportExample.Criteria> getOredCriteria() {
        return oredCriteria;
    }
    ...
    protected abstract static class GeneratedCriteria {
        protected java.util.List<com.ruoyi.common.bean.po.PostWebPscAddressBatchExportExample.Criterion> criteria;

        protected GeneratedCriteria() {
            super();
            criteria = new java.util.ArrayList<com.ruoyi.common.bean.po.PostWebPscAddressBatchExportExample.Criterion>();
        }
        ...
        public java.util.List<com.ruoyi.common.bean.po.PostWebPscAddressBatchExportExample.Criterion> getAllCriteria() {
            return criteria;
        }

        public java.util.List<com.ruoyi.common.bean.po.PostWebPscAddressBatchExportExample.Criterion> getCriteria() {
            return criteria;
        }
