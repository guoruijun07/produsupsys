...
public class PostWebQpsEndTrajectoryOutside {
    /**
     *  id
     */
    private Integer id;
     ...
     * @mbggenerated
     */
    public PostWebQpsEndTrajectoryOutside(Integer id, String traceno, java.util.Date optime, String opname, String oporgsimplename, String recordLength) {
        this.id = id;
     ...
     * @mbggenerated
     */
    public PostWebQpsEndTrajectoryOutside() {
        super();
    }
