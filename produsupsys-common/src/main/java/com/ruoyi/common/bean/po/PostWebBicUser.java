...
public class PostWebBicUser {
     ...
     * @mbggenerated
     */
    public PostWebBicUser(Integer id, String username, String password, String realName, String mobile, String imei, String mac, Integer status, String token, java.util.Date invalidDate, Integer orgNum, String orgName, Double remainingSum, String projectBase, String remark, Long roleId, java.util.Date modifyTime, java.util.Date createTime, String receive1, String receive3, String receive2, String receive4, String receive5) {
        this.id = id;
