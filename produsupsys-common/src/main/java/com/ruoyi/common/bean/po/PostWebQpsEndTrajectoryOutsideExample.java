...
public class PostWebQpsEndTrajectoryOutsideExample {
    /**
     * post_web_qps_end_trajectory_outside
     */
     ...
     * post_web_qps_end_trajectory_outside
     */
    protected java.util.List<com.ruoyi.common.bean.po.PostWebQpsEndTrajectoryOutsideExample.Criteria> oredCriteria;

    /**
     *
     * @mbggenerated
     */
    public PostWebQpsEndTrajectoryOutsideExample() {
        oredCriteria = new java.util.ArrayList<com.ruoyi.common.bean.po.PostWebQpsEndTrajectoryOutsideExample.Criteria>();
    }
     ...
     * @mbggenerated
     */
    public java.util.List<com.ruoyi.common.bean.po.PostWebQpsEndTrajectoryOutsideExample.Criteria> getOredCriteria() {
        return oredCriteria;
    }
    ...
    protected abstract static class GeneratedCriteria {
        protected java.util.List<com.ruoyi.common.bean.po.PostWebQpsEndTrajectoryOutsideExample.Criterion> criteria;

        protected GeneratedCriteria() {
            super();
            criteria = new java.util.ArrayList<com.ruoyi.common.bean.po.PostWebQpsEndTrajectoryOutsideExample.Criterion>();
        }
        ...
        public java.util.List<com.ruoyi.common.bean.po.PostWebQpsEndTrajectoryOutsideExample.Criterion> getAllCriteria() {
            return criteria;
        }

        public java.util.List<com.ruoyi.common.bean.po.PostWebQpsEndTrajectoryOutsideExample.Criterion> getCriteria() {
            return criteria;
        }
