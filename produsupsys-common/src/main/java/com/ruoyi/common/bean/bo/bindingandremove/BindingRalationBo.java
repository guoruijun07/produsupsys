...
public class BindingRalationBo extends CommonParameters{
    ...
    public String getBnucode() {
        return bnucode;
    }

    public void setBnucode(String bnucode) {
        this.bnucode = bnucode;
    }
