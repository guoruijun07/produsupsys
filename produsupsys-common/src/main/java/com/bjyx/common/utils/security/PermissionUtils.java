package com.bjyx.common.utils.security;
...
public class PermissionUtils
{
    ...
    public static String getMsg(String permissionsStr)
    {
        ...
        if (StringUtils.endsWithIgnoreCase(permission, com.bjyx.common.constant.PermissionConstants.ADD_PERMISSION))
        {
            msg = MessageUtils.message(CREATE_PERMISSION, permission);
        }
        else if (StringUtils.endsWithIgnoreCase(permission, com.bjyx.common.constant.PermissionConstants.EDIT_PERMISSION))
        {
            msg = MessageUtils.message(UPDATE_PERMISSION, permission);
        }
        else if (StringUtils.endsWithIgnoreCase(permission, com.bjyx.common.constant.PermissionConstants.REMOVE_PERMISSION))
        {
            msg = MessageUtils.message(DELETE_PERMISSION, permission);
        }
        else if (StringUtils.endsWithIgnoreCase(permission, com.bjyx.common.constant.PermissionConstants.EXPORT_PERMISSION))
        {
            msg = MessageUtils.message(EXPORT_PERMISSION, permission);
        }
        else if (StringUtils.endsWithAny(permission,
                new String[] { com.bjyx.common.constant.PermissionConstants.VIEW_PERMISSION, com.bjyx.common.constant.PermissionConstants.LIST_PERMISSION }))
        {
