...
public class GenController extends BaseController
{
    ...
    @Autowired
    private com.ruoyi.generator.service.IGenTableService genTableService;

    @Autowired
    private com.ruoyi.generator.service.IGenTableColumnService genTableColumnService;
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"produsupsys.zip\"");
