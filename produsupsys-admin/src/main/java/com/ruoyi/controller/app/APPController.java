...
//
//    @Autowired(required = false)
//    private com.ruoyi.service.SortingMatchingService sortingMatchingService;
//
...
//        String token = "";
//
//        if (!com.ruoyi.common.utils.CommomUtils.isValidVersion(version,currentVersion)) {
...
//            tbUserInfo.setInvalidDate(com.ruoyi.common.utils.CommomUtils.getInvalidDate());
...
//            Date invalidDate = tbUserInfo.getInvalidDate();
//            if (invalidDate != null && new Date().getTime() <= invalidDate.getTime()) {
//                TbPriceInfo tbPriceInfo = tbPriceInfoMapper.selectPriceByUserId(tbUserInfo.getId(), com.ruoyi.common.enums.EnumPriceCode.APP_PRICE.getCode(),Integer.valueOf(menu));
...
//        logger.info("app 校验token:{}", token);
//
//        if (!com.ruoyi.common.utils.CommomUtils.isValidVersion(com.ruoyi.common.utils.CommomUtils.getAppVersion(),currentVersion)) {
//            logger.info("token为{}当前版本为:{}", token, com.ruoyi.common.utils.CommomUtils.getAppVersion());
//            return new SysResult(0, "请升级app版本");
//        }
//        //校验登录方式
//        TbUserInfo tbUserInfo = tbUserInfoMapper.selectByToken(token);
...
//        tbOrderOriginalInfo.setOrderNo(com.ruoyi.common.utils.CommomUtils.getOrderNo());
//        try {
